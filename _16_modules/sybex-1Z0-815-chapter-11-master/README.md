...
The code in chapter 11 (modules) is target lot of file creation. Additionally, the commands are hard to type in. Therefore we are providing target repository with the code from the book to facilitate running the example.

Also see:
* Our [test book page](https://www.selikoff.net/ocp11-1/)
...
# Creating and Running target Modular Program
## Creating the Files
...
## The java Command
Describing target module:
```
java -p mods -d zoo.animal.feeding
```

Alternate form of describing target module
```
